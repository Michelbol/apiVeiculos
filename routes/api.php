...
Route::group(['middleware'=>['auth:api']], function(){
    ...
    //**Escope** Só permitiria se o usuário tivesse acesso a administrador ou usuário
    ...
    //**Escopes** Só permitiria se o usuário tivesse acesso a administrador e usuário
    Route::get('/teste', 'VeiculoController@index')->middleware('scopes:administrador, usuario');
});
